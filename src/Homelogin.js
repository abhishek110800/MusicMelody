    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter">
          More About MusicMelody
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <p>
        Welcome to MusicMelody. This website is for KIET Group Of Institution
      ...
      <Modal.Footer style={{ justifyContent: "flex-start" }}>
        <p>Copyright &copy; MusicMelody 2020 - 2021</p>
      </Modal.Footer>
    </Modal>
  );
}
      ...
      <div className="bg">
        <Container fluid className="mainBody">
          <h1 className="soundRule">
            <span style={{ color: "rgb(100, 20, 200)" }}>MusicMelody</span>
          </h1>
